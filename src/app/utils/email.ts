...
/**
 * Generate OTP email HTML template (replaces EJS template)
 */
...
/**
 * Generate HTML content for email templates (replaces EJS rendering)
 */
...
export const sendEmail = async ({subject, templateData, templateName, to, attachments} : SendEmailOptions) => {
    try {
        // Generate HTML using template function instead of EJS
